...
class TestSQLiteStorageV3(unittest.TestCase):
        ...
        entity_data = [
            {
                ...
                "cmm_type": "Class",
                "dependencies": [
                    {"name": "BaseClass", "rel_type": "inherits"}
                ],
                "methods": [
                    {
                        "name": "my_method",
    ...
    def test_upsert_file(self):
        ...
        cmm1 = CMMEntity(schema_version="v0.3", entities=[
            {"name": "OldClass", "type": "class"}
        ])
        ...
        cmm2 = CMMEntity(schema_version="v0.3", entities=[
